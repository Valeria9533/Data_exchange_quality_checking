...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->checkBox1->Location = System::Drawing::Point(409, 77);
			...
			this->richTextBox1->Size = System::Drawing::Size(137, 208);
			this->richTextBox1->TabIndex = 7;
			this->richTextBox1->Text = L"";
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(68, 36);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(238, 36);
			...
			this->label4->Location = System::Drawing::Point(235, 20);
			...
			this->groupBox1->Size = System::Drawing::Size(413, 358);
			...
			this->label5->Location = System::Drawing::Point(65, 177);
			...
			this->label6->Location = System::Drawing::Point(235, 239);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(68, 193);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(238, 255);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(68, 255);
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(238, 315);
			...
			this->label7->Location = System::Drawing::Point(65, 239);
			...
			this->label13->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.3F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label13->Location = System::Drawing::Point(481, 193);
			...
			this->label12->Location = System::Drawing::Point(406, 177);
			this->label12->Name = L"label12";
			this->label12->Size = System::Drawing::Size(105, 13);
			this->label12->TabIndex = 40;
			this->label12->Text = L"Transmission interval";
			// 
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(409, 193);
			...
			this->label11->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.3F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label11->Location = System::Drawing::Point(455, 255);
			...
			this->label10->Location = System::Drawing::Point(406, 239);
			...
			// textBox8
			// 
			this->textBox8->Location = System::Drawing::Point(409, 255);
			...
			this->checkBox3->Location = System::Drawing::Point(409, 119);
			...
			this->label9->Location = System::Drawing::Point(65, 81);
			...
			this->comboBox1->Location = System::Drawing::Point(68, 98);
			...
			this->label8->Location = System::Drawing::Point(235, 177);
			...
			// textBox7
			// 
			this->textBox7->Location = System::Drawing::Point(238, 193);
			...
			this->checkBox2->Location = System::Drawing::Point(409, 36);
			...
			// richTextBox2
			// 
			this->richTextBox2->Location = System::Drawing::Point(226, 44);
			this->richTextBox2->Name = L"richTextBox2";
			this->richTextBox2->ReadOnly = true;
			this->richTextBox2->Size = System::Drawing::Size(137, 208);
			...
			this->label14->Location = System::Drawing::Point(223, 28);
			this->label14->Name = L"label14";
			this->label14->Size = System::Drawing::Size(86, 13);
			this->label14->TabIndex = 9;
			this->label14->Text = L"Transmitted data";
			// 
			// MyForm
			// 
...
#pragma endregion
	...
	private: System::Void checkBox1_CheckedChanged(System::Object^  sender, System::EventArgs^  e) {
		...
		if (checkBox1->Checked == true) {
			...
			try {
				int time_interval = Convert::ToInt16(textBox9->Text);

				//if (time_interval >= 5) {
					this->timer1->Interval = time_interval;
				//}
				//else {
				//	MessageBox::Show("Time interval must be >= 5 ms"); checkBox1->Checked = false; return;
				//}
			}
			catch(...) {
				MessageBox::Show("Enter time interval"); checkBox1->Checked = false; return;
			}
			...
			if (checkBox3->Checked == true) {
				...
				if (serialPort1->IsOpen == true) {
					...
					if (serialPort1->BytesToRead > 0) {
						...
						// %
						quality = CS_OK / (CS_OK + CS_WR + errors) * 100;
					}
				}
			}
		...
		if (serialPort1->IsOpen == true) {
			...
			try {
				for (int i = 0; i < 5; i++) {
					...
					richTextBox2->AppendText(Convert::ToString(hex_val));
